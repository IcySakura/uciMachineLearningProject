<?php
// See object_detection.py for more info
...
if(isset($_FILES['file'])){
    ...
    if(move_uploaded_file($_FILES['file']['tmp_name'], $target_path)) {
        ...
        //echo "python3 object_detection.py ./input/" . $_FILES['file']['name'];
        $msg_back = shell_exec("python3 object_detection.py ./input/" . $_FILES['file']['name']);
        echo $msg_back;
